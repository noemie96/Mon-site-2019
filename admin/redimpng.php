...
$source = imagecreatefrompng("../images/upload/".$_GET['image']); // La photo est la source
...
$TailleImageChoisie = getimagesize("../images/upload/".$_GET['image']);
...
$rep_nom="../images/upload/mini_".$_GET['image'];
